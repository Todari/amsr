...
const MainLandingInfo = () => {
  ...
  return (
    <div className="snap-always bg-purple-100 snap-center w-full h-[100dvh] flex flex-col items-center justify-center pt-24 p-8">
      <div className="w-full h-full max-w-3xl flex flex-col gap-2 ">
        <div className="basis-1/4 bg-white rounded-3xl flex flex-col py-4 px-6 justify-end">
        ...
        <div className="basis-3/4 flex flex-row gap-2 w-full h-full">
          <div className="flex flex-col gap-2 w-full">
            <div className="basis-1/3 bg-white rounded-3xl w-full h-full flex flex-col items-center justify-center" >
              <SMILE />
            </div>
            <div className="basis-2/3 bg-white rounded-3xl w-full h-full py-4 px-6" >
              <TypographyP text="아무사람대잔치~~" className="font-bold"></TypographyP>
              <TypographyMuted text="아무사람대잔치~~"></TypographyMuted>
            </div>
          </div>
          <div className="flex flex-col gap-2 w-full h-full">
            <div className="basis-2/3 bg-white rounded-3xl w-full h-full flex flex-col justify-between" >
            ...
            <div className="basis-1/3 bg-white rounded-3xl w-full h-full flex  flex-col justify-end py-4 px-6 " >
              <TypographyP text="아무사람대잔치~~" className="font-bold"></TypographyP>
              <TypographyMuted text="아무사람대잔치~~"></TypographyMuted>
            </div>
          </div>
