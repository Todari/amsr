  ...
  return (
    ...
    <div className={twMerge("flex gap-2", opponent ? "flex" : "flex-row-reverse")}>
      ...
      <div className={twMerge("flex flex-col gap-2", opponent ? "items-start" : "items-end")}>
        ...
        <div className={twMerge("flex flex-col gap-1", opponent ? "items-start" : "items-end")}>
        <div className={twMerge("flex py-2 px-3 rounded-sm max-w-[230px]", opponent ? "bg-neutral-700 " : "bg-yellow-300")}>
